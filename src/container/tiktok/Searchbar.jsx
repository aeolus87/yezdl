// src/container/tiktok/TikTokSearchBar.jsx
import React, { useState } from "react";

function TikTokSearchBar({ onSearch }) {
  ...
  const handleSubmit = (e) => {
    ...
    if (inputValue.trim()) {
      ...
      setError("Please enter a TikTok link.");
    }
  };
...
export default TikTokSearchBar;